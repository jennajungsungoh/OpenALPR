...
namespace alpr
{
  ...
  vector<Point> PlateCorners::findPlateCorners()
  {
    ...
    if (pipelineData->config->debugPlateCorners)
    {
      ...
      line(imgCorners, this->bestTop.p1, this->bestTop.p2, Scalar(255, 0, 0), 1, cv::LINE_AA);
      line(imgCorners, this->bestRight.p1, this->bestRight.p2, Scalar(0, 0, 255), 1, cv::LINE_AA);
      line(imgCorners, this->bestBottom.p1, this->bestBottom.p2, Scalar(0, 0, 255), 1, cv::LINE_AA);
      line(imgCorners, this->bestLeft.p1, this->bestLeft.p2, Scalar(255, 0, 0), 1, cv::LINE_AA);
