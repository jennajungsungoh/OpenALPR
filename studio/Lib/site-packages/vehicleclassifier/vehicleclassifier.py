...
class VehicleClassifier:
    def __init__(self, config_file, runtime_dir, license_key="", use_gpu=False, gpu_id=0, gpu_batch_size=10):
        ...
        self._recognize_array_func.argtypes = [
            ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_ubyte), ctypes.c_longlong, VehicleClassifierCRegionOfInterest]
    ...
    def recognize_ndarray(self, country, ndarray, x=None, y=None, width=None, height=None):
        ...
        :return: An OpenALPR analysis in the form of a response dictionary
        """
        img_height, img_width = ndarray.shape[:2]
        ...
        ptr = self._recognize_raw_image_func(self.vehicleclassifier_pointer, country, ndarray.flatten(), bpp, img_width, img_height, roi)
