...
public class Alpr {
    ...
    public native void initialize(String country, String configFile, String runtimeDir, String licenseKey);
    ...
    {
        initialize(country, configFile, runtimeDir, null);
    }

    public Alpr(String country, String configFile, String runtimeDir, String licenseKey)
    {
        initialize(country, configFile, runtimeDir, licenseKey);
    }
